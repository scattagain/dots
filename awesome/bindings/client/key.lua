...
client.connect_signal('request::default_keybindings', function()
    awful.keyboard.append_client_keybindings {
        ...
        awful.key({ mod.super, mod.control }, "space", awful.client.floating.toggle,
            { description = "toggle floating", group = "client" }),
        awful.key({ mod.super, mod.control }, "Return", function(c) c:swap(awful.client.getmaster()) end,
        ...
        awful.key({ mod.super, mod.control }, "m",
            function(c)
